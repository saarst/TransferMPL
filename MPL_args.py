...
parser.add_argument('--data_dir', default='datasets/hymenoptera_data', type=str, help='data path')
...
parser.add_argument('--warmup_epoch_num', default=0, type=int, help='warmup steps')
...
parser.add_argument('--test', action='store_true', help='only test model on test set')
...
parser.add_argument('--n_trials', default=None, type=int, help='n_trials for optuna')
parser.add_argument('--timeout', default=None, type=int, help='timeout for optuna')
