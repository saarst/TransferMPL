...
parser.add_argument('--warmup_epoch_num', default=20, type=int, help='warmup steps')
...
parser.add_argument('--threshold', default=0.75, type=float, help='pseudo label threshold')
parser.add_argument('--temperature', default=1.05, type=float, help='pseudo label temperature')
parser.add_argument('--lambda_u', default=0.27, type=float, help='coefficient of unlabeled loss')
parser.add_argument('--uda_steps', default=80, type=float, help='warmup steps of lambda-u')
...
parser.add_argument('--test_mode', action='store_true', default=False, help='only test')
