...
#     nn.init.uniform_(moving_dot_product, -limit, limit)
    ...
    for step in range(args.start_step, args.total_steps):
        ...
        with amp.autocast(enabled=args.amp):
            ...
            t_loss_l = criterion(t_logits_l, targets.long())
            ...
            s_loss_l_old = F.cross_entropy(s_logits_l.detach(), targets.long())
            s_loss = criterion(s_logits_us, hard_pseudo_label.long())
        ...
        with amp.autocast(enabled=args.amp):
            ...
            s_loss_l_new = F.cross_entropy(s_logits_l.detach(), targets.long())
...
#             dot_product = dot_product - moving_dot_product
            ...
            t_loss_mpl = dot_product * F.cross_entropy(t_logits_us, hard_pseudo_label.long())
...
def main():
    ...
    args.workers = 0 if torch.cuda.is_available() else 0
